...
const char *fname = "./tests/data/table.store";


START_TEST(create)
{
    auto test = new HashTable<int32_t, int32_t>(fname, 100);
...
START_TEST(insert)
{
    auto test = new HashTable<int32_t, int32_t>(fname, 10);
...
Suite *test_suite()
{
    Suite *suite = suite_create("Disk HashTable Tests");
